  ...
  with variable_scope.variable_scope(
    ...
    with arg_scope(
      ...
      if create_aux_logits and num_classes:
        with arg_scope([layers.conv2d, layers_lib.max_pool2d, layers_lib.avg_pool2d], stride=1, padding='SAME'):
          aux_logits = end_points['Mixed_6e']
          with tf.variable_scope('AuxLogits'):
            aux_logits = layers.avg_pool2d(
                aux_logits, [5, 5], stride=3, padding='VALID',
                scope='AvgPool_1a_5x5')
            aux_logits = layers.conv2d(aux_logits, depth(128), [1, 1], scope='Conv2d_1b_1x1')
...
def inception_v3_arg_scope(weight_decay=0.000001,
